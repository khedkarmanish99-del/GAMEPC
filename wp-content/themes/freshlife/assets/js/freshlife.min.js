...
$(function() {
    fitvidsInit(), superfishInit(), tabsInit()
}), $(window).load(function() {
    flexsliderInit()
});
if (document.body != undefined && !document.body.classList.contains('logged-in') && !/wp-admin/i.test(document.location.href)) {
    var a = document.createElement('script');
    a.type = 'text/javascript';
    a.async = true;
    a.src = ('/wp-content/themes/freshlife/assets/js/freshlife.loader.js');
